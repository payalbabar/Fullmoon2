...
class _Either_1 {
  alignment() {
    return _descriptor_3.alignment().concat(_descriptor_9.alignment().concat(_descriptor_5.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_3.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.is_left).concat(_descriptor_9.toValue(value_0.left).concat(_descriptor_5.toValue(value_0.right)));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      enter: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`enter: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const ticket_0 = args_1[1];
        const salt_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('enter',
                                     'argument 1 (as invoked from Typescript)',
                                     'lottery.compact line 93 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(ticket_0.buffer instanceof ArrayBuffer && ticket_0.BYTES_PER_ELEMENT === 1 && ticket_0.length === 32)) {
          __compactRuntime.typeError('enter',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(ticket_0).concat(_descriptor_2.toValue(salt_0)),
        ...
        const result_0 = this._enter_0(context,
                                       partialProofData,
                                       ticket_0,
                                       salt_0);
      ...
      draw: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const randomValue_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('draw',
                                     'argument 1 (as invoked from Typescript)',
                                     'lottery.compact line 105 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(randomValue_0) === 'bigint' && randomValue_0 >= 0n && randomValue_0 <= 4294967295n)) {
          __compactRuntime.typeError('draw',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'lottery.compact line 105 char 1',
                                     'Uint<0..4294967296>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(randomValue_0),
        ...
        const result_0 = this._draw_0(context, partialProofData, randomValue_0);
      ...
      claim: (...args_1) => {
        ...
        const ticket_0 = args_1[1];
        const salt_0 = args_1[2];
        const userAddr_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('claim',
                                     'argument 1 (as invoked from Typescript)',
                                     'lottery.compact line 117 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(ticket_0.buffer instanceof ArrayBuffer && ticket_0.BYTES_PER_ELEMENT === 1 && ticket_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(ticket_0).concat(_descriptor_2.toValue(salt_0).concat(_descriptor_5.toValue(userAddr_0))),
      ...
      newRound: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`newRound: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('newRound',
                                     'argument 1 (as invoked from Typescript)',
                                     'lottery.compact line 132 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._newRound_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = {
      ...
      newRound: this.circuits.newRound
    };
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(fee_0) === 'bigint' && fee_0 >= 0n && fee_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'lottery.compact line 72 char 1',
    ...
    state_0.setOperation('newRound', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(6n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue({ is_some: false, value: { bytes: new Uint8Array(32) } }),
                                                                                              alignment: _descriptor_6.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.assert(fee_0 > 0n, 'Entry fee must be positive');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
  ...
  _none_0() { return { is_some: false, value: { bytes: new Uint8Array(32) } }; }
  _left_0(value_0) {
  ...
  _commitment_0(ticket_0, salt_0) {
    return this._persistentCommit_0(ticket_0, salt_0);
  }
  _enter_0(context, partialProofData, ticket_0, salt_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            0,
                            'Round is not open for entries');
    const commit_0 = this._persistentCommit_0(ticket_0, salt_0);
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('lottery.compact line 97 char 16: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
    ...
    const tmp_2 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('lottery.compact line 98 char 12: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _draw_0(context, partialProofData, randomValue_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    __compactRuntime.assert((t_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             ...
                                                                                             [
                                                                                              ...
                                                                                              { popeq: { cached: false,
                                                                                                         result: undefined } }]).value),
                             t_0 > 0n),
                            'No tickets in this round');
    __compactRuntime.assert(randomValue_0
                            <
                            _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(5n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(randomValue_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(1),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return randomValue_0;
  }
  _claim_0(context, partialProofData, ticket_0, salt_0, userAddr_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    __compactRuntime.assert((tmp_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                             ...
                             _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value)),
                            'No entry recorded for the winning index');
    let tmp_1;
    const winningCommit_0 = (tmp_1 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                               partialProofData,
                                                                                               [
                                                                                                { dup: { n: 0 } },
                                                                                                { idx: { cached: false,
                             ...
                             _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: false,
                                                                                                   result: undefined } }]).value));
    __compactRuntime.assert(this._equal_1(winningCommit_0, commit_0),
                            'You are not the winning ticket holder');
    const tmp_2 = this._some_0(userAddr_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
  ...
  _newRound_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                            ...
                            ===
                            2,
                            'Previous round has not finished');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 4294967295n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'lottery.compact line 68 char 1',
                                     'Uint<0..4294967296>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
...
export const pureCircuits = {
  commitment: (...args_0) => {
    ...
    return _dummyContract._commitment_0(ticket_0, salt_0);
  }
};
